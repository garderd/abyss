...
<div class="bx-authform">
	...
	<h4 class="form__header">Восстановление пароля</h4>

	<form name="bform" method="post" id="forgot_form" target="_top" action="<?= POST_FORM_ACTION_URI;?>">

	
		<div class="bx-authform-formgroup-container forgot-input">
			<div class="form__label bx-authform-label-container">E-mail, к которому привязана ваша учетная запись</div>
		...
		<p class="bx-authform-content-container form__text">На указанный адрес придет письмо со ссылкой для восстановления пароля</p>
		...
		<div class="bx-authform-formgroup-container">
			<input type="submit" class="form__submit" name="<?= $arResult['FIELDS']['action'];?>" value="Восстановить пароль" />
		</div>
...
<script type="text/javascript">
	document.bform.<?= $arResult['FIELDS']['email'];?>.focus();
</script>
