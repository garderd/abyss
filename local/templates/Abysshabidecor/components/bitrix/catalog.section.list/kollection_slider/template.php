					...
					<div class="swiper-slide collection" id="<?= $this->GetEditAreaId($arCollection['ID']); ?>">
						<a href="<?= $arCollection['SECTION_PAGE_URL'] ?>">
							<div class="img-wrapper">
								<?
									$arImage = CFile::GetFileArray($arCollection['~PICTURE']);
									$arImageResize = CFile::ResizeImageGet($arImage, array('width' => 500, "height" => 500), BX_RESIZE_IMAGE_PROPORTIONAL);
								?>
								<img src="<?= $arImageResize['src'] ?>" alt="<?= $arCollection['NAME'] ?>">
							</div>
