...
else
{
	...
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
		...
		<h1 class="h1 order-header"><?$APPLICATION->ShowTitle(false)?></h1>
		<div id="bx-soa-order" class="row bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
			...
			<div class="col-sm-8 bx-soa">
				...
				<div id="bx-soa-region" data-visited="false" class="bx-soa-section bx-active">
					<div class="bx-soa-section-title-container row">
						...
						<div class="col-xs-12 col-sm-3 text-right"><a href="" class="bx-soa-editstep"><span>изменить</span></span></a></div>
					</div>
					<div class="bx-soa-section-content"></div>
				</div>
				...
				<? if ($arParams['DELIVERY_TO_PAYSYSTEM'] === 'p2d'): ?>
					...
					<div id="bx-soa-pickup" data-visited="false" class="bx-soa-section" style="display:none">
						<div class="bx-soa-section-title-container row">
							...
							<div class="col-xs-12 col-sm-3 text-right"><a href="" class="bx-soa-editstep"><span>изменить</span></a></div>
						</div>
						<div class="bx-soa-section-content"></div>
					</div>
				<? else: ?>
				...
				<? if ($arParams['BASKET_POSITION'] === 'after'): ?>
					...
					<div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active">
						<div class="bx-soa-section-title-container row">
							...
							<div class="col-xs-12 col-sm-3 text-right"><a href="javascript:void(0)" class="bx-soa-editstep"><span>изменить</span></span></a></div>
						</div>
						<div class="bx-soa-section-content"></div>
					</div>
				<? endif ?>
				...
				<div id="bx-soa-orderSave">
					...
					<a href="javascript:void(0)" style="margin: 10px 0" class="pull-left uk-button uk-button-default" data-save-button="true">
						<?=$arParams['MESS_ORDER']?>
					</a>
				</div>
			...
			<!--	SIDEBAR BLOCK	-->
			<div id="bx-soa-total" class="col-sm-5 bx-soa-sidebar">
				<a class="link-arrow back-to-card" href="/cart/"><span>Вернуться в корзину</span></a>
				<? if ($arParams['BASKET_POSITION'] === 'before'): ?>
					<!--	BASKET ITEMS BLOCK	-->
					<div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active">
						<div class="bx-soa-section-title-container row">
							<h2 class="bx-soa-section-title col-sm-7">
								<?=$arParams['MESS_BASKET_BLOCK_NAME']?>
							</h2>
						</div>
						<div class="bx-soa-section-content"></div>
