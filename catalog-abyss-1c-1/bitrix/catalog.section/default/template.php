                    ...
                    <div class="catalog-section__element" id="<?= $this->GetEditAreaId($arElement['ID']); ?>">
                        <div class="section-element__border">
                            ...
                            <? if (is_array($arElement["OFFERS"]) && !empty($arElement["OFFERS"])) : ?>
                                ...
                                ?> 
                                    <? if (is_countable($offers_can_buy) && count($offers_can_buy) == 1) : ?>
                                        <? if ($arOffer['PRODUCT']['QUANTITY'] > 0) : ?>
                                            <? if ($arOffer["PRICES"]["BASE"]["PRINT_VALUE"] != $arOffer["PRICES"]["BASE"]["PRINT_DISCOUNT_VALUE"]) : ?>
                                                <p class='section-element__price'><span class="catalog-section__discount-price"><?= $arOffer["PRICES"]["BASE"]["PRINT_VALUE"] ?></span><?= $arOffer["PRICES"]["BASE"]["PRINT_DISCOUNT_VALUE"] ?></p>
                                            <? else : ?>
                                                <p class='section-element__price'><?= $arOffer["PRICES"]["BASE"]["PRINT_VALUE"] ?></p>
                                            <? endif; ?>
                                        <? else : ?>
                                            <p class='section-element__price'><?= $arOffer["PRICES"]["BASE"]["PRINT_VALUE"] ?></p>
                                        ...
                                        <? endif; ?>
                                    <? else : ?>
                                        <p class='section-element__price'>от <?= $arOffer["PRICES"]["BASE"]["PRINT_DISCOUNT_VALUE"] ?></p>
                                    <? endif; ?>
                                ...
                                ?>
                            <? else : ?>
                                <? foreach ($arElement["PRICES"] as $code => $arOffer["PRICES"]["BASE"]) : ?>
                                    <? if ($arElement['CAN_BUY']) : ?>
                                        <? if ($arOffer["PRICES"]["BASE"]["CAN_ACCESS"]) : ?>
                                            <? if ($arOffer["PRICES"]["BASE"]["DISCOUNT_VALUE"] < $arOffer["PRICES"]["BASE"]["VALUE"]) : ?>
                                                <p class='section-element__price'><s class='section-element__old-price'><?= $arOffer["PRICES"]["BASE"]["PRINT_VALUE"] ?></s>
                                                    <?= $arOffer["PRICES"]["BASE"]["PRINT_DISCOUNT_VALUE"] ?></p>
                                            <? else : ?>
                                                <p class='section-element__price'><?= $arOffer["PRICES"]["BASE"]["PRINT_VALUE"] ?></p>
                                            <? endif; ?>
                                        <? endif; ?>
